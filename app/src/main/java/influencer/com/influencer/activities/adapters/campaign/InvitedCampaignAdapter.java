...
import influencer.com.influencer.activities.apiResponses.registerAPI.influencerAPI.campaign.invitedCampaign.InvitedCampaign;

public class InvitedCampaignAdapter extends RecyclerView.Adapter<InvitedCampaignAdapter.AtiveViewHolder> {

    private List<InvitedCampaign> imgList; ;
    Context context;

    public InvitedCampaignAdapter(List<InvitedCampaign> imgList) {
    ...
    public void onBindViewHolder(@NonNull AtiveViewHolder holder, int position) {
        ...
        final InvitedCampaign recpojo = imgList.get(position);
