...
import influencer.com.influencer.activities.apiResponses.registerAPI.influencerAPI.campaign.previousCampaign.PreviousCampaign;
import influencer.com.influencer.activities.fragments.influencer.campaign.Fragment_PreviousCampaign;

public class PreviousCampaignAdapter extends RecyclerView.Adapter<PreviousCampaignAdapter.AtiveViewHolder> {

    private List<PreviousCampaign> imgList; ;
    Context context;

    public PreviousCampaignAdapter(List<PreviousCampaign> imgList) {
    ...
    public void onBindViewHolder(@NonNull AtiveViewHolder holder, int position) {
        ...
        final PreviousCampaign recpojo = imgList.get(position);
